/*eslint-disable*/ module.exports = {
    messages: {
        ...
        'Harvest {0} SUSHI & {1} ALCX': ['收穫 ', ['0'], ' SUSHI & ', ['1'], ' ALCX'],
        ...
        'Pour a hot bowl of MISO, the new <0>token launchpad</0> from SUSHI':
            '來一碗熱味噌湯，Sushi全新的<0>代幣 Launchpad</0>',
        Price: '價格',
        'Price Impact': '價格影響',
        ...
        'Swap To (est.):': '交換至（估算）：',
        'Swap To:': '交換至：',
        'Swap for SAK3 token on SUSHI now. Click here to swap.': '即刻在Sushi上購買SAK3。點擊此處兌換。',
        TVL: 'TVL',
