/*eslint-disable*/ module.exports = {
    messages: {
        ...
        'Harvest {0} SUSHI & {1} ALCX': ['收获', ['0'], ' SUSHI & ', ['1'], ' ALCX'],
        ...
        'Pour a hot bowl of MISO, the new <0>token launchpad</0> from SUSHI':
            '来一碗热味增汤, Sushi全新的<0>代币Launchpad</0>',
        Price: '价格',
        'Price Impact': '价格影响',
        ...
        'Swap To (est.):': '交换至（估算）：',
        'Swap To:': '交换至：',
        'Swap for SAK3 token on SUSHI now. Click here to swap.': '即刻在Sushi上购买SAK3。点击此处兑换。',
        TVL: 'TVL',
