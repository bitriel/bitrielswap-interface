...
import { ChainId, CurrencyAmount, JSBI, Token, Trade } from '@bitrielswap/sdk'
...
export default function Swap() {
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Swap`)} | SEL</title>
                <meta
                    name="description"
                    content="BitrielSwap allows for swapping of ERC20 compatible tokens across multiple networks"
                />
            </Helmet>
            <TokenWarningModal
